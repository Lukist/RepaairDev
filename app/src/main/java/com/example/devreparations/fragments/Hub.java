...
public class Hub extends Fragment {
    ...
    TextView hubDescription, hubSubtitile;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hubDescription = root.findViewById(R.id.hubDescription);
        hubSubtitile = root.findViewById(R.id.hubSubtitile);

        Typeface typeface = getResources().getFont(R.font.poppins_italic);
        hubDescription.setTypeface(typeface);
        hubSubtitile.setTypeface(typeface);
